...
import 'package:flutter_health/screens/Screensfromsettings/account.dart';
import 'package:flutter_health/screens/empty_main_screen.dart';
import 'package:hive/hive.dart';
import 'package:path_provider/path_provider.dart';

import '../models/model.dart';
import '../models/settings_options_model.dart';
...
class _SettingsscreenState extends State<Settingsscreen> {
  ...
  final List<SettingsOptionModel> settingsOptions = [
    SettingsOptionModel(title: 'Account', screen: Accountscreen()),
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(builder: (context) => Emptymainscreen()),
